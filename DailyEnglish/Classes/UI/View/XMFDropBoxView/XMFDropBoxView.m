...
@interface XMFDropBoxView ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)initTable {
    UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 20, self.frame.size.width, self.frame.size.height-20) style:UITableViewStylePlain];
...
//    }
    ...
    self.frame = CGRectMake(x, y, VIEW_W, 400);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    title.text = [self.dataSource dropBoxView:self itemAtIndex:indexPath.row];
    title.textColor = [UIColor colorWithRed:73/255.0 green:194/255.0 blue:248/255.0 alpha:1];
    title.frame = CGRectMake(0, 15, 100, 20);
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [self.dataSource numberOfItemInDropBoxView:self];
}
